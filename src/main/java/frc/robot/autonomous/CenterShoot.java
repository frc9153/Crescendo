...
public class CenterShoot extends SequentialCommandGroup {
    ...
    public CenterShoot(DriveSwerve m_driveSwerve, UpAndDownForever m_upDown, Archerfish m_archerfish, Esophagus m_esophagus) {
        ...
        addCommands(
            ...
            new WindThenScore(m_archerfish, m_esophagus).withTimeout(0.9)
        );
    }
}