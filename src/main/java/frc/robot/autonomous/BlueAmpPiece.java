...
public class BlueAmpPiece extends SequentialCommandGroup {
    public double speed;
    public double seperate_dist;
    public double align_dist;
    public double dist_to_note;

    public BlueAmpPiece(DriveSwerve m_driveSwerve, UpAndDownForever m_upDown, Archerfish m_archerfish, Esophagus m_esophagus) {
