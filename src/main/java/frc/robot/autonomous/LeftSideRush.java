...
public class LeftSideRush extends SequentialCommandGroup {
    public double speed;
    public double rush_dist;

    public LeftSideRush(DriveSwerve m_driveSwerve, UpAndDownForever m_upDown, Archerfish m_archerfish, Esophagus m_esophagus) {
